...
/* login.html.twig */
class __TwigTemplate_7e3557e4e4c221b7ab285bb171d04afae2cae11f54d282bc33cdfd3d82667b99 extends Twig_Template
{
    ...
    ";
        ...
        echo "\" class=\"form-control\" placeholder=\"Enter your username\" required autofocus>
            ...
            <div class=\"form-group\">
                <div class=\"col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4\">
                    <button type=\"submit\" class=\"btn btn-default btn-primary\"><span class=\"fa fa-log-in\"></span> Login</button>
                </div>
            </div>
        </form>
    </div>
